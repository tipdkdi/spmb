    ...
    public function run()
    {
        ...
        try {
            ...
            DB::table('pmbs')->insert([
                [
                    "pmb_nama" => "Penerimaan Pascasarjana Program Doktor (S3) Studi Islam",
            ...
            DB::table('ujians')->insert([
                [
                    "ujian_nama" => "Ujian Penerimaan Jalur Mandiri Pascasarjana Program Doktor (S3) Studi Islam",
                    "tempat" => "IAIN Kendari",
