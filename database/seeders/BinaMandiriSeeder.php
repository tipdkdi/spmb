...
class BinaMandiriSeeder extends Seeder
{
    /**
    ...
    public function run()
    {
        ...
        try {
            ...
            DB::table('ujians')->insert([
                [
                    "ujian_nama" => "Ujian Penerimaan Mahasiswa Jalur Bina Mandiri",
                    "tempat" => "IAIN Kendari",
            ...
            DB::table('ujian_sesis')->insert([
                [
                    "ujian_id" => 4,  ///ini diganti2 sesuai ujian id yang ingin dilaksanakan
                    "sesi" => "1",
                    "jam_mulai" => "08:15:00",
            ...
            $array = [];
            $sesi = 0;
            for ($i = 18; $i <= 18; $i++) { //ini id sesi, jadi contoh ujian id 1 sampai 10 sesi, jadi skrg di sini jadi dari 11 -15 karena sampe 5 sesu
                $sesi = 1;
