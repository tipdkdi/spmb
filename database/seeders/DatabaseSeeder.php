...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('soal_kelompoks')->insert([
            [
                "kelompok_soal_nama" => "TKD 1",
                "keterangan" => "-",
                "is_aktif" => 1,
            ],
            [
                "kelompok_soal_nama" => "TKD 2",
                "keterangan" => "-",
                "is_aktif" => 1,
            ],
            [
                "kelompok_soal_nama" => "TKD 3",
                "keterangan" => "-",
                "is_aktif" => 1,
            ],
            [
                "kelompok_soal_nama" => "TKD 4",
                "keterangan" => "-",
                "is_aktif" => 1,
            ],
            [
                "kelompok_soal_nama" => "TKD 5",
                "keterangan" => "-",
                "is_aktif" => 1,
            ],
            [
                "kelompok_soal_nama" => "TKD 6",
                "keterangan" => "-",
                "is_aktif" => 1,
            ],
            [
                "kelompok_soal_nama" => "TKD 7",
                "keterangan" => "-",
                "is_aktif" => 1,
            ],
            [
